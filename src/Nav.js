...
function Nav() {
  ...
  return (
    ...
    <img 
    className='nav_logo'
    src="https://banner2.cleanpng.com/20180702/qac/kisspng-netflix-television-show-streaming-media-film-netflix-logo-5b3a032be0bbd4.1045980715305285559205.jpg" alt=""></img> 
      <img 
